...
import com.continuumai.continuumaiandroidunitybuild.tflite.PoseEstimation;
import com.continuumai.continuumaiandroidunitybuild.tflite.PoseEstimationFloatMobileNet;
...
public class Camera2BasicFragment extends Fragment
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    ...
    try {
      // create either a new ImageClassifierQuantizedMobileNet or an PoseEstimationFloatMobileNet
      classifier = new PoseEstimationFloatMobileNet(getActivity());
  ...
  private void classifyFrame() {
    ...
    drawView.setDrawPoint(classifier.mPrintPointArray, classifier.getRatio());
